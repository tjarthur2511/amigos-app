...
const ProfilePage = () => {
  ...
  const adminButtonClasses = "bg-coral text-white font-bold border-none rounded-[30px] py-2.5 px-5 text-sm shadow-[0_4px_12px_rgba(0,0,0,0.15)] cursor-pointer transition-all duration-200 ease-in-out hover:bg-coral-dark hover:shadow-lg";
  const profileFormButtonClasses = "text-coral border-2 border-coral px-8 py-3 rounded-full font-bold transition duration-300 hover:bg-coral hover:text-white hover:shadow-md focus:outline-none focus:ring-2 focus:ring-coral disabled:opacity-50 disabled:cursor-not-allowed";
